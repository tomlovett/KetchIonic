angular.module('Ketch').factory('preloads', [function() {
	...
	pre.playerDB = {
		...
		2: {_id : 2, first: 'Julie', last: 'Hamkin', handle: 'Hammie', gender: 'f', games: [], points: [], },
		3: {_id : 3, first: 'Jake', last: 'Williams', handle: 'Jake', gender: 'm', games: [], points: [], },
		4: {_id : 4, first: 'Allie', last: 'G', handle: 'Allie', gender: 'f', games: [], points: [], },
		...
		7: {_id : 7, first: 'Hannah', last: 'BoBannah', handle: 'Scout', gender: 'f', games: [], points: [], } ,
		8: {_id : 8, first: 'Courtney', last: 'Boosh', handle: 'Court', gender: 'f', games: [], points: [], } ,
		9: {_id : 9, first: 'Stan', last: 'LeMan', handle: 'Stan', gender: 'm', games: [], points: [], } ,
		10: {_id : 10, first: 'Caitlin', last: 'Indigo', handle: 'Caitlin', gender: 'f', games: [], points: [], } ,
		11: {_id : 11, first: 'Johnny', last: 'Indigo', handle: 'Johnny', gender: 'm', games: [], points: [], },
		12: {_id : 12, first: 'Lauren', last: 'CurryPot', handle: 'Laur-Laur', gender: 'f', games: [], points: [], },	
